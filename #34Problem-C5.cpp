...
// read number and retrun its index in array if found otherwise retrun -1
...
// void SearchArray(int arr[100], int arrLength)
// {
//     int Number = ReadPositiveNumber("Number you are looking for is : ");
//     int counter = 0;
//     for (int i = 0; i < arrLength; i++)
//     {
//         if (arr[i] == Number)
